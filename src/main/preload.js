...
const EVENTS = [
  'launch:progress', 'launch:state', 'launch:notice', 'java:progress',
  'server:event', 'install:progress', 'logs:entry',
  'versions:auto-added', 'auth:restored', 'auth:deviceCode', 'auth:msWindow', 'auth:msBrowser',
  // NX Cloud
  'nx:presence', 'nx:lock', 'nx:chat', 'nx:announcements', 'nx:file:progress', 'nx:voice',
];
