...
const SETTINGS_FALLBACK = {
  theme: 'emerald', memoryMB: 4096, memoryAuto: true, smartInstall: true,
  neuraxClient: true, clientThirdPartyMods: false, clientFpsMode: 'ultra',
  selectedVersion: null, selectedInstanceId: null,
  showSnapshots: true, showOldVersions: true, closeLauncherOnLaunch: false,
  rememberWindowSize: true, windowWidth: 1200, windowHeight: 800, keysAcknowledgedAt: null,
};
